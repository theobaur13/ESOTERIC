...
from legacy.FEVERISH_3_5.utils.document_retrieval import title_match_search, score_docs, text_match_search, extract_focals, extract_questions, calculate_answerability_score_SelfCheckGPT, calculate_answerability_score_tiny, extract_answers, extract_questions, extract_polar_questions
from legacy.FEVERISH_3_5.utils.NER import extract_entities
from elasticsearch import Elasticsearch
from dotenv import load_dotenv

class EvidenceRetriever:
    def __init__(self, data_path, title_match_docs_limit=20, title_match_search_threshold=0, answerability_threshold=0.65, answerability_docs_limit=20, text_match_search_db_limit=1000):
